...
This is the first step in shifting left: after you block `apk` at runtime, you prevent the package manager from existing in the image (xref:acs-02-policy-and-risk.adoc[02] deploy-time, xref:acs-03-cicd-and-automation.adoc[03] build-time).
...
Next: xref:acs-07-installation.adoc[Installation].
