...
Prod GitOps is a *second remote* — leave it for xref:tssc-16-prod-gitops.adoc[6.2]. `app-operate` NetworkPolicy on staging stays *open* (that is not the xref:tssc-10-build-networkpolicy.adoc[4.3] build-egress Check).
