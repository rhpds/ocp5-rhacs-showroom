...
Hands-on ACS runtime enforcement is xref:acs-06-network-and-runtime.adoc[acs-06] (kill a pod that runs a package manager). Deeper hunting is xref:301-04-runtime-threat-detection.adoc[301-04]. This module stays on the node/FIO side.
