...
Full Sigstore/TAS signing of *your* builds is xref:tssc-12-sign-keyless.adoc[Lightwell 5.1]—do not install a second signing stack here unless TAS is already on the cluster.
...
Supply-chain integrity here is **catalog image + digest pin + admission**. Signing *your* builds remains TSSC-00 / 201-04. ACS deploy-time policies (xref:acs-02-policy-and-risk.adoc[acs-02]) are the other admission door for CVEs and labels.
