...
* Next, confirm you can open the OpenShift console and ACS Central tabs in the Showroom UI. Log in with the credentials on the xref:index.adoc[Welcome] page:
+
[cols="1,1,1"]
|===
...
+
Log in with username `{vm_user}` and the VM password from the xref:index.adoc[Welcome] page.
+
