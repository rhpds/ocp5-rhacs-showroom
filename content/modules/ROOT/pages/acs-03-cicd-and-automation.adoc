...
*Expected:* Failing APK and GitOps-managed policies. If you created *Alpine Linux Package Manager in Image - Enforce Deploy* in xref:acs-02-policy-and-risk.adoc[02 Policy and Risk], it appears here as well.
...
Congrats! On to xref:acs-04-compliance.adoc[Compliance]!
