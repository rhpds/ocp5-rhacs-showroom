...
* The `python-alpine-golden` repository is **public** in Quay (same Settings path as `frontend` in xref:acs-00-setup-install-navigation.adoc#navigating-the-registry[acs-00]) so the cluster can import it
