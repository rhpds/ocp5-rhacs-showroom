...
Attach the notifier to a policy you already have. This lab reuses *No bash allowed* from xref:acs-02-policy-and-risk.adoc[02 Policy and Risk].
...
IMPORTANT: Run the following command if you have not created the policy in xref:acs-02-policy-and-risk.adoc[02]:
...
You wired a notifier, attached it to a policy, and called the Central API. Next: xref:acs-06-network-and-runtime.adoc[Network and Runtime Security].
